...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  methods: {
	    chooseAnswer: function chooseAnswer(i, index) {
	      var _this = this;
	      ...
	      setTimeout(function () {
	        _this.triggerTransX = _this.triggerTransY = 0;
	      }, 1500);
	      if (this.list[this.iNow].right === i) {
	        ...
	        setTimeout(function () {
	          _this.imgs.tigger = _this.imgs.tiggerError;
	        }, 1000);
