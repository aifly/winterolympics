...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsIndexVue = __webpack_require__(17);

	var _componentsIndexVue2 = _interopRequireDefault(_componentsIndexVue);

	var _componentsObserableJs = __webpack_require__(23);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _snowJs = __webpack_require__(14);

	var _snowJs2 = _interopRequireDefault(_snowJs);

	var _methodsJs = __webpack_require__(15);

	var _methodsJs2 = _interopRequireDefault(_methodsJs);

	var _velocityAnimate = __webpack_require__(24);
	...
	exports['default'] = {
	  ...
	  methods: {
	      ...
	      if (this.list[this.iNow].right === i) {
	        ...
	        (0, _velocityAnimate2['default'])(this.$refs['tigger'], {
	          ...
	          complete: function complete() {
	            ...
	            (0, _velocityAnimate2['default'])(_this.$refs['tigger'], {
	              translateX: 0,
	              translateY: 0
	            }, {
	              delay: 400,
	        ...
	        setTimeout(function () {
	          _this.imgs.tigger = _this.imgs.tiggerSuccess;
	        }, 2000);
	      } else {
	        //回答错误
	        ...
	        (0, _velocityAnimate2['default'])(this.$refs['tigger'], {
	          ...
	          complete: function complete() {
	            ...
	            (0, _velocityAnimate2['default'])(_this.$refs['tigger'], {
	              ...
	              duration: 1000,
	              complete: function complete() {
	                s.imgs.tigger = _this.imgs.tiggerError;
	                s.computedINow();
	                (0, _velocityAnimate2['default'])(_this.$refs['tigger'], {
	                  translateX: 0,
	                  translateY: 0
	    ...
	    snowAnimate: function snowAnimate(i) {
	      ...
	      this.snowsProticles = (0, _jquery2['default'])('.zmiti-a-list:eq(' + this.iNow + ') li').eq(i).find('.zmiti-snow');
	      var k = 0;
	      this.snowsProticles.each(function (i, item) {
	        ...
	        _this2.snowArr[i].transX += item.spX;
	        _this2.snowArr[i].transY += item.spY;
	        if (_this2.snowArr[i].transY > _this2.viewH) {
	          k++;
	          if (k >= snowCount) {
	            _this2.clickIndex = -1;
	            _this2.snowArr.forEach(function (h, sn) {
	              h.transX = 0;
	              h.transY = 0;
	            });
	          }
	    ...
	    computedINow: function computedINow() {
	      ...
	      setTimeout(function () {
	        _this3.index += 1;
	        _this3.clickItmeIndex = -1;
	        if (_this3.index > _this3.questionLen) {
	          _this3.index = _this3.questionLen;
	          ...
	          */
	          if (_this3.score < 10) {
	            _this3.rightAnswer.key = 'over1';
	          }
	          if (_this3.score < 7) {
	            _this3.rightAnswer.key = 'over2';
	          }
	          if (_this3.score < 4) {
	            _this3.rightAnswer.key = 'over3';
	          }

	          var scale = '99';
	          scale = (Math.random() * 10 + (_this3.score - 1) * 10).toFixed(1);
	          switch (_this3.score) {
	            case 0:
	              scale = 0;
	              break;
	          ...
	          _methodsJs2['default'].wxConfig('我答对了' + _this3.score + '题，击败了' + scale + '%的网友，邀你PK一下', '邀你PK一下');
	          return;
	        }
	        _this3.iNow = _this3.questionLen - _this3.index;
	      }, 10);
	    }
	  },
	  mounted: function mounted() {
	    ...
	    var t = setInterval(function () {
	      ...
	      _this4.snows.push(new _snowJs2['default']());
	    }, 50);

	    var zmitiRequestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame;
	    var render = function render() {
	      _this4.snows.forEach(function (item, i) {
	        item.animate();
	      });
	      if (_this4.clickIndex > -1) {
	        _this4.snowAnimate(_this4.clickIndex);
	      }
	    ...
	    obserable.on('mainStart', function () {
	      ...
	      var timer = setInterval(function () {
	        _this4.seconds++;
	        var sec = _this4.seconds % 60;
	        var min = _this4.seconds / 60 | 0;
	        _this4.time = (min < 10 ? '0' + min : min) + ':' + (sec < 10 ? '0' + sec : sec);
	      }, 1000);
	      _this4.computedINow();
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QList = [{
		title: '在第16届法国阿尔贝维尔冬奥会上，（）为中国实现冬奥奖牌“零的突破”。',
		answers: ['李琰', '叶乔波', '张艳梅'],
		answers1: [{}, {}, {}],
		right: 1,
		answerStyle: [{
		...
		title: '（）在1998年18届日本长野冬奥会女子自由式滑雪空中技巧项目上为中国实现冬奥会雪上项目奖牌"零"的突破。',
		answers: ['徐囡囡', ' 李妮娜', '郭心心'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '（）上中国队包揽了当届冬奥会短道速滑女子项目全部四枚金牌。',
		...
		title: '申雪、赵宏博在（）冬奥会上为中国首次夺得花样滑冰双人滑金牌。',
		answers: ['2006年意大利都灵冬奥会', '2010年加拿大温哥华冬奥会', ' 2002年美国盐湖城冬奥会'],
		answers1: [{}, {}, {}],
		right: 1,
		answerStyle: [{
		...
		title: '1924年（）承办了当时被称为“冬季运动周”的运动会，两年后国际奥委会正式将其更名为第1届冬季奥林匹克运动会。',
		...
		title: '从（）起，冬奥会与夏奥会以2年为间隔交叉举行。',
		answers: ['1994年的挪威利勒哈默尔冬季奥运会', '1992年法国阿尔贝维尔冬季奥运会', '1988年加拿大卡尔加里冬季奥运会'],
		answers1: [{}, {}, {}],
		isBig: true,
		right: 0,
		answerStyle: [{
			background: 'url(' + _assetsJs2['default'].answersbig + ') no-repeat center top',
			backgroundSize: 'contain'
		}, {
			background: 'url(' + _assetsJs2['default'].answersbig + ') no-repeat center top',
			backgroundSize: 'contain'
		...
		title: '第（）届冬奥会将于2022年在中国北京和张家口举行。',
		answers: ['24', '25', '26'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '（）创造历史，成为第一个既举办过夏奥会又举办冬奥会的城市。',
		answers: ['温哥华', '盐湖城', '北京'],
		answers1: [{}, {}, {}],
		right: 2,
		answerStyle: [{
		...
		title: '（）是史上第六个连续三次申办冬奥失败的城市，另外5个分别为芬兰的拉赫蒂、瑞士的锡永、保加利亚的索非亚、瑞典的厄斯特松德、西班牙的哈卡。',
		...
		title: '在一届冬奥会上获金牌最多的运动员是美国男子速滑健将海登，他在1980年第13届冬奥会上共获（） 枚金牌。',
		answers: ['五', '六', '七'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '（）上，被罗格称赞为“有史以来最伟大的速滑选手”的克拉默在“冰上马拉松”男子10000米决赛中，因为教练的错误指示，在6800米处的转弯时忘记了换道，结果在成绩排名第一的情况下被判犯规，丢掉金牌。',
		...
		title: '都灵奥会花样滑冰双人滑自由滑的比赛中，（）在冲击世界上最高难度的抛跳时摔在冰面上严重受伤，简单的包扎之后，两人顺利地完成了一系列高难度动作，他们勇敢的表现不但征服了全场观众，也征服了现场裁判，最终拼得一枚银牌！',
		...
		title: '（）上，男子单板滑雪平行大回转比赛中，瑞士选手菲利浦-舒赫在决赛中击败了自己的哥哥西蒙-舒赫夺得冠军。',
		...
		title: '2006年都灵冬季奥运会上，这就是韩国（），夺得了短道速滑8枚金牌中的6枚，成为当届冬奥会上发挥最出色的单项运动队。',
		...
		title: '都灵冬奥会上，跨国夫妻来自瑞士的弗里登和来自美国的维斯科特分别在单板滑雪赛场男、女越野争先赛上夺得（）。',
		answers: ['金牌', '银牌', '铜牌'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '（）开幕式上，5朵漂亮的雪绒花在幻化成奥运五环时出现故障，其中一环未能盛开。',
		...
		title: '索契冬奥会，庞清佟健获得（），又一次与金牌擦肩而过，但赛后深情对望时，佟健说：“就算输得什么都没有了，我还有庞清啊！”',
		answers: ['第四', '铜牌', '银牌'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '2014年索契冬奥会短道速滑女子500米决赛中，孤军作战的（）由于其他三位选手接连意外摔倒，她一人一马当先滑到最后摘金，为中国实现该项目四连冠，这也是中国代表团本届冬奥会的首金。',
		answers: ['李坚柔', '周洋', '王濛'],
		answers1: [{}, {}, {}],
		right: 0,
		answerStyle: [{
		...
		title: '（）花样滑冰冰舞比赛中，立陶宛人托比亚斯不小心用冰刀划开了男伴斯塔纽纳斯的裤子，不过男伴还是坚持完成比赛，最总他们总排名位列第17位。',
		answers: ['都灵冬奥会', '温哥华冬奥会', '索契冬奥会'],
		answers1: [{}, {}, {}],
		right: 2,
		answerStyle: [{
		...
		_createClass(ZmitiSnow, [{
			...
			value: function animate() {
				...
				if (this.dom && this.dom.length > 0) {
					...
					this.dom = (0, _jquery2['default'])('#' + this.id);
				}
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _zmitisnowJs = __webpack_require__(21);
